...
This is a [demo Django application](http://damp-tor-3124.herokuapp.com/) configured to run on Heroku.  It serves as a basic library OpenURL resolver using the 360Link API from Serials Solutions.
